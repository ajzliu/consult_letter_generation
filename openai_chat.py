...
# Load OpenAI API key from secrets file (config.json)
with open('config.json', 'r') as fopen:
    OPENAI_API_KEY = json.load(fopen)["OPENAI_API_KEY"]
...
def chat_content(**kwargs):
    ...
    response = client.chat.completions.create(model="gpt-4-turbo-2024-04-09", **kwargs)
